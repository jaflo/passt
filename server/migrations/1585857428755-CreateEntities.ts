...
export class CreateEntities1585857428755 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "card" ("id" SERIAL NOT NULL, "shape" "card_shape_enum" NOT NULL, "fillStyle" "card_fillstyle_enum" NOT NULL, "color" "card_color_enum" NOT NULL, CONSTRAINT "PK_9451069b6f1199730791a7f4ae4" PRIMARY KEY ("id"))`, undefined);
